...
c.aliases = {
        ...
        'yt' : 'open -t https://www.youtube.com/search?q=',
        'ghb': 'open -t https://www.github.com/nickbatsaras'
        }
...
## Type: Dict
# c.bindings.key_mappings = {'<Shift-Return>': '<Return>', '<Ctrl-J>': '<Return>', '<Ctrl-M>': '<Return>', '<Shift-Enter>': '<Return>', '<Enter>': '<Return>', '<Ctrl-6>': '<Ctrl-^>', '<Ctrl-[>': '<Escape>', '<Ctrl-Enter>': '<Ctrl-Return>'}
...
## Type: Padding
# c.tabs.indicator.padding = {'bottom': 2, 'top': 2, 'right': 4, 'left': 0}
...
config.bind('YY', 'spawn youtube-dl -o /home/$USER/Music/%(title)s.%(ext)s --extract-audio --audio-format mp3 {url:pretty}')
